...
for i= 1:10
    ...
    alzdist(i, 1:i) = (controlmean(i, 1:i) - alzcov(i,1:i))/controlstd(i, 1:i);
    autdist(i, 1:i) = (controlmean(i, 1:i) - autcov(i,1:i))/controlstd(i, 1:i);
    schizodist(i, 1:i) = (controlmean(i, 1:i) - schizocov(i,1:i))/controlstd(i, 1:i);
